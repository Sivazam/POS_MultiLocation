...
export const mapFranchiseFeaturesToAppConfig = (franchiseFeatures: FranchiseStoredFeatures): FeatureConfig => {
  return {
    ...
    inventory: {
      ...
      vendorManagement: franchiseFeatures.inventory,
...
export const storeConfigurations = {
  ...
  simple: {
    ...
    inventory: {
      ...
      vendorManagement: false, // Simplified - no vendor tracking
...
export const createFeatureCheckers = (config: FeatureConfig) => ({
  ...
  canManageVendors: () => isFeatureEnabled('inventory.vendorManagement', config),
